...
'Ban IP warning'				 => '<strong>Внимание!</strong> Необходимо быть очень осторожны при блокировке по IP-диапазону, поскольку таким образом можно заблокировать много пользователей, имеющих такой же частичный IP.',    //<strong>Warning!</strong> You should be very careful when banning an IP-range because of the possibility of multiple users matching the same partial IP.
...
'Ban message help'  			 => 'Показывается заблокированному пользователю, когда он/она посетит форум',    //Displayed to the banned user when he/she visits the forums
