...
'Installed extensions warn'		=>	'<strong>ВНИМАНИЕ!</strong> Если удалить расширение, то данные, связанные с ним, будут удалены из базы данных и не смогут быть восстановлены путем повторной установки. Чтобы сохранить данные, просто отключите это расширение.',
...
'Maxtestedon warning'			=>	'Данное расширение не тестировалось на этой версии PunBB и поэтому может быть с ней несовместимо.',
...
'No XML support'				=>	'PHP не имеет встроенной поддержки XML. Поддержка XML необходима для установки расширений. Для получения помощи обратитесь к документации по PHP.',
...
'Uninstall note'				=>	'Прочтите после установки',
'Hotfix download failed'		=>	'Ошибка загрузки и установки расширения. Подождите несколько минут и попытайтесь снова.',
...
'Missing dependency'			=>	'Это расширение не может быть установлено, если «%s» установлен и включен',
